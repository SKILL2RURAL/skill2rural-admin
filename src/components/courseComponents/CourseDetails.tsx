  ...
  return (
    <div className="bg-white p-10 mt-6 font-neue-haas">
      <div className="flex mb-10">
        <label className="text-[#253B4B] w-[10rem]">Course title</label>
        <input
          type="type"
      ...
      <div className="flex mb-10">
        <label className="text-[#253B4B] w-[10rem]">Description</label>
        <textarea
      ...
      <div className="flex mb-10">
        <label className="text-[#253B4B] w-[10rem]">Course type</label>
        <select
      ...
      <div className="flex gap-12">
        ...
        <div className="w-[110px] h-[95px] border border-[#C4C4C4] rounded-md relative">
          <Image
